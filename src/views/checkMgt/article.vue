<template>
  <div class="main">
    <div class="top">
      <div class="class">
        <span style="padding-right:20px;">文章类别</span>
    ...
    <el-table :data="tableData" stripe style="width: 100%">
      <el-table-column prop="id" label="文章名称" align="center"></el-table-column>
      <el-table-column prop="id" label="文章分类" align="center">
        <template slot-scope="scope">
          <el-button @click="view(scope.row)" type="text" size="small">查看</el-button>
        </template>
      </el-table-column>
      <el-table-column prop="id" label="发布时间" align="center"></el-table-column>
