<template>
  <div class="main">
    ...
    <el-table :data="tableData" stripe style="width: 100%">
      ...
      <el-table-column prop="id" label="子分类" align="center">
        <template slot-scope="scope">
          <el-button @click="view(scope.row)" type="text" size="small">11</el-button>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    //查看子分类
    view(row){
      this.$router.push({path:'/service/subClass',query:{id:row.id}})
    },
    openForm() {
